...
def finetune_model():
    ...
    train_dataloader = get_dataloader(split="train_prefs", batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, debug_mode=False)
    eval_dataloader = get_dataloader(split="test_prefs", batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, debug_mode=False)
