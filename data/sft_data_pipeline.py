...
def get_dataloader(split="train", batch_size=64, shuffle=True, num_workers=4, debug_mode=False, max_length=576):
    dataset = SmolTalkDataset(split=split, max_length=max_length, debug_mode=debug_mode)
